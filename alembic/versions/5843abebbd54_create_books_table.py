...
Revision ID: 5843abebbd54
Revises: 
Create Date: 2026-09-10 12:45:16.175861
...
def upgrade() -> None:
    ...
    op.create_index('idx_book_author_year', 'books', ['author', 'year'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_book_author_year', table_name='books')
    op.drop_table('books')
    # ### end Alembic commands ###
